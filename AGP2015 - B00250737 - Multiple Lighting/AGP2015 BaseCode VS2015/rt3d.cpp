...
void setLightPos(const GLuint program, const GLfloat *lightPos, GLuint lightNumber)
{
	string number = std::to_string(lightNumber);
	int uniformIndex = glGetUniformLocation(program, ("lightPosition[" + number + "]").c_str());
...
void setLight(const GLuint program, const lightStruct light, GLuint lightNumber)
{
	string number = std::to_string(lightNumber);
	// pass in light data to shader
	int uniformIndex = glGetUniformLocation(program, ("light[" + number + "].ambient").c_str());
	cout << "Amb" << lightNumber << ": " << uniformIndex << endl;
	...
	cout << "Diffuse" << lightNumber << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + number + "].specular").c_str());
	glUniform4fv(uniformIndex, 1, light.specular);
	cout << "Spec" << lightNumber << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("lightPosition[" + number + "]").c_str());
	glUniform4fv(uniformIndex, 1, light.position);
	cout << "Position" << lightNumber << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + number + "].attConst").c_str());
	glUniform1f(uniformIndex, light.attConst);
	cout << "Constant" << lightNumber << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + number + "].attLinear").c_str());
	glUniform1f(uniformIndex, light.attLinear);
	cout << "Linear" << lightNumber << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + number + "].attQuadratic").c_str());
	glUniform1f(uniformIndex, light.attQuadratic);
	cout << "Quadratic" << lightNumber << ": " << uniformIndex << endl;
}
